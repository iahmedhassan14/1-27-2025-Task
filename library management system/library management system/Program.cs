...
namespace library_management_system
{
    ...
    public class Library
    {
        ...
        {
            Book? book = Book.Find(book => book.Title.Equals(title, StringComparison.OrdinalIgnoreCase));
        ...
        {
            Book? book = Book.Find(x => x.Title.Equals(title, StringComparison.OrdinalIgnoreCase));
